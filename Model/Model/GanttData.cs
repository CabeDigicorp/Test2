...
namespace Model
{
    ...
    public class TimeRuler
    {
        ...
        {
            TimeRulersDetail = new List<TimeRulerDetail>();
            TimeRulerDetail TimeRulerDetail = new TimeRulerDetail();
            TimeRulersDetail.Add(TimeRulerDetail);
            TimeRulerDetail = new TimeRulerDetail();
            TimeRulerDetail.UnitTime = 5;
            TimeRulersDetail.Add(TimeRulerDetail);
            TimeRulerDetail = new TimeRulerDetail();
            TimeRulerDetail.UnitTime = 6;
            TimeRulersDetail.Add(TimeRulerDetail);
        }
    }
    [ProtoContract]
