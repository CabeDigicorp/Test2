...
{
    public class ComputoAttributiSettingsView : AttributiSettingsView
    {
        ...
        //    //Articolo
        //    string key = BuiltInCodes.EntityType.Prezzario;
        ...
        //    //Contatti
        //    key = BuiltInCodes.EntityType.Contatti;
        //    _entityTypesKeyOnInit.Add(key);
        //    items.Add(new RiferimentiComboItem() { Key = EntityTypes[key].GetKey(), Name = EntityTypes[key].Name, Category = LocalizationProvider.GetString("Sezioni") });


        //    //Elemento
        //    key = BuiltInCodes.EntityType.Elementi;
        //    _entityTypesKeyOnInit.Add(key);
        //    items.Add(new RiferimentiComboItem() { Key = EntityTypes[key].GetKey(), Name = EntityTypes[key].Name, Category = LocalizationProvider.GetString("Sezioni") });
