<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="activatemachine.aspx.cs" Inherits="JoinLicenseService.ActivateMachine" %>
...
<head runat="server">
    <title>License Service Activation Console - Activate A Machine</title>
</head>
<body>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:Button ID="bntDisable" runat="server" 
            OnClick="btnDisableLicense_Click" Text="Disable license"
            Width="260px" />
        <br />
        <br />
