...
namespace PH.WorkingDaysAndTimeUtility
{
    ...
    //{
        ...
        //public static DateTime AddWorkingDaysForward(this DateTime dateTime, int days, 
        //                                             List<DateTime> datesToExclude, List<DayOfWeek> workDaysOfTheWeeks)
        //{
        ...
        //public static DateTime AddWorkingDaysBack(this DateTime dateTime, int days,
        //                                             List<DateTime> datesToExclude, List<DayOfWeek> workDaysOfTheWeeks)
        //{
        ...
        //            //check if current is a workingDay
        //            if (workDaysOfTheWeeks.Contains(start.DayOfWeek))
        //            {
        //                if (datesToExcludeList.Count == 0)
        //                {
        //                    moreAdd = false;
        ...
        //                {
        //                    var holiDayInList = datesToExcludeList
        //                        .FirstOrDefault(x => x.Date == start.Date);
